...
#define NOTIFY_PADDING_MESSAGE_Y		20.f		// Padding Y between each message
#define NOTIFY_FADE_IN_OUT_TIME			150			// Fade in and out duration
#define NOTIFY_DEFAULT_DISMISS			3000		// Auto dismiss after X ms (default, applied only of no data provided in constructors)
#define NOTIFY_OPACITY					0.70f		// 0-1 Toast opacity
...
namespace ImGui
{
	...
	NOTIFY_INLINE void RenderNotifications()
	{
		...
		ImVec2 centerPosition = ImVec2(screenSize.x * 0.5f, screenSize.y * 0.20f);
		SetNextWindowSize(ImVec2(420.0f, 100.0f), ImGuiCond_Always); // Imposta la larghezza e l'altezza desiderate
		...
		for (auto i = 0; i < notifications.size(); i++)
		{
			...
			SetNextWindowPos(centerPosition, ImGuiCond_Always, ImVec2(0.5f, 0.5f));

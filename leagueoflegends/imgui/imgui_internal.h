...
//#endif
    ...
    IMGUI_API bool          BeginChildExOld(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          SubTab(const char* label,  bool selected, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);

...
class SpellSlot2
{
	union {
		...
		DEFINE_MEMBER_N(float _cooldown_expire, UPasta::Offsets::SpellBook::SpellSlot::CooldownExpire);
		DEFINE_MEMBER_N(DWORD _charges, UPasta::Offsets::SpellBook::SpellSlot::Charges);
		DEFINE_MEMBER_N(float _cooldown, UPasta::Offsets::SpellBook::SpellSlot::CoolDown);
		DEFINE_MEMBER_N(SpellInfo2* _spell_info, UPasta::Offsets::SpellBook::SpellSlot::SpellInfoInstance);
		DEFINE_MEMBER_N(TargetingClient2* _targeting_client, UPasta::Offsets::SpellBook::SpellSlot::TargetingClientInstance);
	};

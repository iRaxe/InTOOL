...
#define HEADER "\
  ____           _        _                    _               \n\
 |  _ \ __ _ ___| |_ __ _| |    ___   __ _  __| | ___ _ __   \n\
 | |_) / _` / __| __/ _` | |   / _ \ / _` |/ _` |/ _ \ '__|  \n\
 |  __/ (_| \__ \ || (_| | |__| (_) | (_| | (_| |  __/ |     \n\
 |_|   \__,_|___/\__\__,_|_____\___/ \__,_|\__,_|\___|_|     \n\
	 "
#define MENU_PREFIX " "
#define ERROR_PREFIX "# "
#define INFO_PREFIX "> "
...
namespace io {
	...
	void printSpace(std::string msg) {
		printLogText(msg, " ", 0);
	...
	void printInjectionResult(action curAction, launchMethod curLaunchMethod, bool success) {
		std::string resultString = "DLL Injection";
	...
	void printUnlinkResult(bool success) {
		std::string resultString = "DLL Unlinking";
